...
enum AuthenticationErrorCode: Int, ALTErrorEnum, CaseIterable {
    ...
    var errorFailureReason: String {
        switch self {
        case .noTeam: return NSLocalizedString("你的 Apple ID 没有任何开发者团队？", comment: "")
        case .noCertificate: return NSLocalizedString("找不到开发者证书。", comment: "")
        case .teamSelectorError: return NSLocalizedString("呈现团队选择器视图时出错。", comment: "")
        case .missingPrivateKey: return NSLocalizedString("找不到证书的私钥。", comment: "")
        case .missingCertificate: return NSLocalizedString("找不到证书。", comment: "")
        case .certificateLimitReachedFree: return NSLocalizedString("免费开发者账户的 1 个证书限额已用尽。请撤销现有证书后重试。", comment: "")
        case .certificateLimitReachedPaid: return NSLocalizedString("付费开发者账户可生成的证书数量已达到上限。请至少撤销一个证书后重试。", comment: "")
        }
    }
}
